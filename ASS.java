...
public class ASS extends Applet {
    ...
    public void paint(Graphics g) {
       ...
       drawLine(g, centerX - 100, centerY - 150, centerX + 100, centerY - 150);
		...
		drawLine(g, centerX - 100, centerY - 150, centerX-75, centerY - 200);
		drawLine(g, centerX-75, centerY - 200, centerX+125, centerY - 200);
		drawLine(g, centerX +125, centerY - 200, centerX +125 , centerY + 100);
		drawLine(g, centerX +125, centerY +100, centerX+100, centerY + 150);
		drawLine(g, centerX + 125 ,centerY - 200, centerX+100, centerY - 150);
		...
		drawLine(g, centerX + 100, centerY - 100, centerX+260 , centerY -260); */
		 ...
		 // Draw a circle
        drawCircle(g, centerX, centerY, 99);
		drawCircle(g, centerX+112 ,centerY+10, 12);
		drawCircle(g, centerX, centerY-175, 24);
...
/*<applet code="ASS.class" width="1000" height="1000">
 </applet>
